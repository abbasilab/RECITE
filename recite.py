...
from recite.benchmark.evaluator import batched_judge_evaluator, clear_python_gpu_cache, load_benchmark_prompts, run_single_sample
...
def _judge_batch_task(
    ...
    metrics_list = batched_judge_evaluator(
        batch,
        model=judge_model,
        prompts=prompts,
